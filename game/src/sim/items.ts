...
export const COMPONENTS: Record<string, Item> = {
  ...
  plate: { id: "plate", name: "Ironplate", short: "ARM", desc: "+5 armour", color: "#9aa8b4", buff: { armor: 5 }, component: true },
...
export const ITEMS: Record<string, Item> = {
  ...
  greatmail: { id: "greatmail", name: "Greatmail", short: "ARM", desc: "+7 armour", color: "#9aa8b4", buff: { armor: 7 } },
  ...
  ironhide: { id: "ironhide", name: "Ironhide", short: "TANK", desc: "+160 HP & +4 armour", color: "#9a6a40", buff: { hp: 160, armor: 4 } },
  ...
  towershield: { id: "towershield", name: "Tower Shield", short: "WALL", desc: "+22% HP & +5 armour", color: "#6f8aa6", buff: { hpPct: 22, armor: 5 } },
  ...
  duelistedge: { id: "duelistedge", name: "Duelist's Edge", short: "DUEL", desc: "+18% attack & +4 armour", color: "#d8a04a", buff: { atkPct: 18, armor: 4 } },
  ...
  dancersmail: { id: "dancersmail", name: "Dancer's Mail", short: "DANCE", desc: "+5 armour & +25% speed", color: "#8ec0d8", buff: { armor: 5, speedPct: 25 } },
};
