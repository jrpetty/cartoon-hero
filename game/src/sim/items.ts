...
export const COMPONENTS: Record<string, Item> = {
  ...
  plate: { id: "plate", name: "Ironplate", short: "ARM", desc: "+4 armour", color: "#9aa8b4", buff: { armor: 4 }, component: true },
...
export const ITEMS: Record<string, Item> = {
  ...
  greatmail: { id: "greatmail", name: "Greatmail", short: "ARM", desc: "+6 armour", color: "#9aa8b4", buff: { armor: 6 } },
  ...
  ironhide: { id: "ironhide", name: "Ironhide", short: "TANK", desc: "+160 HP & +3 armour", color: "#9a6a40", buff: { hp: 160, armor: 3 } },
  ...
  towershield: { id: "towershield", name: "Tower Shield", short: "WALL", desc: "+22% HP & +4 armour", color: "#6f8aa6", buff: { hpPct: 22, armor: 4 } },
  ...
  duelistedge: { id: "duelistedge", name: "Duelist's Edge", short: "DUEL", desc: "+18% attack & +3 armour", color: "#d8a04a", buff: { atkPct: 18, armor: 3 } },
  ...
  dancersmail: { id: "dancersmail", name: "Dancer's Mail", short: "DANCE", desc: "+4 armour & +25% speed", color: "#8ec0d8", buff: { armor: 4, speedPct: 25 } },
};
