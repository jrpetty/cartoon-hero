...
public final class CrushingRecipes {
	...
	static {
		...
		add(Items.RAW_IRON, ModItems.IRON_DUST.get(), 2);
		add(Items.IRON_ORE, ModItems.IRON_DUST.get(), 2);
		add(Items.DEEPSLATE_IRON_ORE, ModItems.IRON_DUST.get(), 2);
		add(Items.RAW_GOLD, ModItems.GOLD_DUST.get(), 2);
		add(Items.GOLD_ORE, ModItems.GOLD_DUST.get(), 2);
		add(Items.DEEPSLATE_GOLD_ORE, ModItems.GOLD_DUST.get(), 2);
		add(Items.NETHER_GOLD_ORE, ModItems.GOLD_DUST.get(), 2);
		add(Items.RAW_COPPER, ModItems.COPPER_DUST.get(), 2);
		add(Items.COPPER_ORE, ModItems.COPPER_DUST.get(), 2);
		add(Items.DEEPSLATE_COPPER_ORE, ModItems.COPPER_DUST.get(), 2);
