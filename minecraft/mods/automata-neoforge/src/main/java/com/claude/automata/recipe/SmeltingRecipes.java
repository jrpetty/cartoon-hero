...
public final class SmeltingRecipes {
	...
	static {
		...
		add(com.claude.automata.registry.ModItems.IRON_DUST.get(), Items.IRON_INGOT);
		add(com.claude.automata.registry.ModItems.GOLD_DUST.get(), Items.GOLD_INGOT);
		add(com.claude.automata.registry.ModItems.COPPER_DUST.get(), Items.COPPER_INGOT);
