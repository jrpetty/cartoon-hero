...
public class RecyclerBlock extends MachineBlock implements BlockEntityProvider {
	...
	@Override
	protected MapCodec<RecyclerBlock> getCodec() {
		return CODEC;
	}
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
		...
		return validateTicker(type, ModBlockEntities.RECYCLER, (w, p, s, be) -> be.tick(w, p, s));
	}
}
