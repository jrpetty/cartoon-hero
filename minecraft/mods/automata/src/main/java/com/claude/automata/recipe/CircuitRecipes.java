...
public final class CircuitRecipes {
	...
	static {
		add(ModItems.LOGIC_CIRCUIT, 1, Items.COPPER_INGOT, 1, Items.REDSTONE, 2, Items.GOLD_NUGGET, 1);
		add(ModItems.LOGIC_CIRCUIT, 2, ModItems.COPPER_DUST, 1, Items.REDSTONE, 2, Items.GLOWSTONE_DUST, 1);
	}
