...
public class MinerBlock extends MachineBlock implements BlockEntityProvider {
	...
	@Override
	protected MapCodec<MinerBlock> getCodec() {
		return CODEC;
	}
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
		...
		return validateTicker(type, ModBlockEntities.MINER, (w, p, s, be) -> be.tick(w, p, s));
	}
}
