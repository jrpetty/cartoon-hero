...
public class CapacitorBlock extends EnergyBlock {
	public static final MapCodec<CapacitorBlock> CODEC = createCodec(CapacitorBlock::new);
	...
	@Override
	protected MapCodec<CapacitorBlock> getCodec() {
		return CODEC;
	}
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
		...
		return validateTicker(type, ModBlockEntities.CAPACITOR, (w, p, s, be) -> be.tick(w, p, s));
	}
}
