...
public class BlockPlacerBlock extends FacingMachineBlock implements BlockEntityProvider {
	...
	@Override
	protected MapCodec<BlockPlacerBlock> getCodec() {
		return CODEC;
	}
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state,
		...
		return validateTicker(type, ModBlockEntities.BLOCK_PLACER, (w, p, s, be) -> be.tick(w, p, s));
	}
}
